...
export declare class SenderLayer extends ListenerLayer {
     ...
     */
    sendImageAsStickerGif(to: string, pathOrBase64: string, options?: AllMessageOptions): Promise<{
        ack: number;
        id: string;
    }>;
    /**
     ...
     * @param to chatId '000000000000@c.us'
     */
    sendImageAsSticker(to: string, pathOrBase64: string, options?: AllMessageOptions): Promise<{
        ack: number;
        id: string;
    }>;
    /**
     ...
     * @param to Chat Id
     */
    stopRecording(to: string): Promise<void>;
    /**
