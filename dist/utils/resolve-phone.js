...
exports.resolvePhoneFromChatId = resolvePhoneFromChatId;
exports.clearResolvePhoneCache = clearResolvePhoneCache;
exports.getResolvePhoneCacheSize = getResolvePhoneCacheSize;
/* Helper to resolve a phone number from a chatId (handles @c.us, @s.whatsapp.net and @lid) */
const cache = new Map();
async function resolvePhoneFromChatId(client, chatId) {
...
function clearResolvePhoneCache() {
    cache.clear();
}
function getResolvePhoneCacheSize() {
    return cache.size;
}
