...
class RetrieverLayer extends sender_layer_1.SenderLayer {
    ...
    async getListMutes(type) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (type) => WAPI.getListMute(type), type);
    }
    /**
     ...
     */
    async getBlockList() {
        return await (0, helpers_1.evaluateAndReturn)(this.page, () => WPP.blocklist.all().map((b) => b.toString()));
    }
    /**
     * Retrieves all chats
    ...
    async getAllChats(withNewMessageOnly = false) {
        ...
        if (withNewMessageOnly) {
            return (0, helpers_1.evaluateAndReturn)(this.page, () => WAPI.getAllChatsWithNewMsg());
        }
        else {
            return (0, helpers_1.evaluateAndReturn)(this.page, () => WAPI.getAllChats());
        }
    }
    /**
    ...
    async checkNumberStatus(contactId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (contactId) => WAPI.checkNumberStatus(contactId), contactId);
    }
    ...
    async getAllChatsWithMessages(withNewMessageOnly = false) {
        ...
        return (0, helpers_1.evaluateAndReturn)(this.page, (withNewMessageOnly) => WAPI.getAllChatsWithMessages(withNewMessageOnly), withNewMessageOnly);
    }
    /**
     * Retrieve all groups
     * Deprecated in favor of {@link listChats}
    ...
    async getAllGroups(withNewMessagesOnly = false) {
        ...
        return await (0, helpers_1.evaluateAndReturn)(this.page, async ({ withNewMessagesOnly }) => {
     ...
     */
    async getAllBroadcastList() {
        const chats = await (0, helpers_1.evaluateAndReturn)(this.page, () => WAPI.getAllChats());
        return chats.filter((chat) => chat.isBroadcast && chat.id._serialized !== 'status@broadcast');
    }
    /**
    ...
    async getContact(contactId) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (contactId) => WAPI.getContact(contactId), contactId);
    }
    /**
    ...
    async getAllContacts() {
        return await (0, helpers_1.evaluateAndReturn)(this.page, () => WAPI.getAllContacts());
    }
    /**
    ...
    async getChatById(contactId) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (contactId) => WAPI.getChatById(contactId), contactId);
    }
    /**
     * Retrieves chat object of given contact id
     * @category Chat
    ...
    async getProfilePicFromServer(chatId) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (chatId) => WAPI._profilePicfunc(chatId), chatId);
    }
    /**
    ...
    async loadEarlierMessages(contactId) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (contactId) => WAPI.loadEarlierMessages(contactId), contactId);
    }
    /**
    ...
    async getStatus(contactId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, async (contactId) => {
    ...
    async getNumberProfile(contactId) {
        ...
        return (0, helpers_1.evaluateAndReturn)(this.page, (contactId) => WAPI.getNumberProfile(contactId), contactId);
    }
    /**
    ...
    async getUnreadMessages(includeMe, includeNotifications, useUnreadCount) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, ({ includeMe, includeNotifications, useUnreadCount }) => WAPI.getUnreadMessages(includeMe, includeNotifications, useUnreadCount), { includeMe, includeNotifications, useUnreadCount });
    }
    /**
     ...
     */
    async getUnreadMessagesInChat(chatId, includeMe = false, includeNotifications = false) {
        return (0, helpers_1.evaluateAndReturn)(this.page, ({ chatId, includeMe, includeNotifications }) => WAPI.getUnreadMessagesInChat(chatId, includeMe, includeNotifications), { chatId, includeMe, includeNotifications });
    }
    /**
     ...
     */
    async getAllUnreadMessages(options) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (opts) => WAPI.getAllUnreadMessages(opts), options);
    }
    /**
    ...
    async getAllNewMessages() {
        return await (0, helpers_1.evaluateAndReturn)(this.page, () => WAPI.getAllNewMessages());
    }
    /**
    ...
    async getAllMessagesInChat(chatId, includeMe, includeNotifications) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, ({ chatId, includeMe, includeNotifications }) => WAPI.getAllMessagesInChat(chatId, includeMe, includeNotifications), { chatId, includeMe, includeNotifications });
    }
    /**
    ...
    async loadAndGetAllMessagesInChat(chatId, includeMe = false, includeNotifications = false) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, ({ chatId, includeMe, includeNotifications }) => WAPI.loadAndGetAllMessagesInChat(chatId, includeMe, includeNotifications), { chatId, includeMe, includeNotifications });
    }
    /**
    ...
    async getChatIsOnline(chatId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (chatId) => WAPI.getChatIsOnline(chatId), chatId);
    }
    /**
    ...
    async getLastSeen(chatId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (chatId) => WAPI.getLastSeen(chatId), chatId);
    }
    /**
     ...
     * @param chatId chat id: xxxxx@c.us
     */
    async getPlatformFromMessage(msgId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (msgId) => WPP.chat.getPlatformFromMessage(msgId), msgId);
    }
    /**
    ...
    async getReactions(msgId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (msgId) => WPP.chat.getReactions(msgId), msgId);
    }
    /**
    ...
    async getVotes(msgId) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (msgId) => WPP.chat.getVotes(msgId), msgId);
    }
    /**
     ...
     * @return Your order
     */
    async getOrder(msgId) {
        return (0, helpers_1.evaluateAndReturn)(this.page, (msgId) => WPP.order.get(msgId), msgId);
    }
    /**
     ...
     * @returns Promise
     */
    async getCommonGroups(wid) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, ({ wid }) => WPP.contact.getCommonGroups(wid), { wid });
    }
    /**
    ...
    async getPnLidEntry(phoneOrLid) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (phoneOrLid) => WPP.contact.getPnLidEntry(phoneOrLid), phoneOrLid);
    }
    /**
     ...
     */
    async getMessagesFromRowId(input) {
        return await (0, helpers_1.evaluateAndReturn)(this.page, (options) => WPP.indexdb.getMessagesFromRowId(options), input);
    }
}
