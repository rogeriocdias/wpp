...
import { Chat, ContactStatus, PartialMessage, ProfilePicThumbObj, WhatsappProfile, Wid } from '../model';
...
export declare class RetrieverLayer extends SenderLayer {
     ...
     */
    getUnreadMessagesInChat(chatId: string, includeMe?: boolean, includeNotifications?: boolean): Promise<PartialMessage[]>;
    /**
     ...
     */
    getAllUnreadMessages(options?: GetAllUnreadMessagesOptions): Promise<PartialMessage[]>;
    /**
     ...
     */
    getMessagesFromRowId(input: GetMessagesFromRowIdOptions): Promise<any[]>;
}
